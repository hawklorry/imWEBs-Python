...
class PastureGrazingManagement(BMPTable):
    """Distribution Table for BMP: Pasture grazing management (37)"""
    __tablename__ = Names.bmp_table_name_pasture_grazing_management
...
class PastureGrazingParameter(BMPTable):
    """Distribution Table for BMP: Pasture grazing management (37)"""
    __tablename__ = 'pasture_grazing_parameter'
